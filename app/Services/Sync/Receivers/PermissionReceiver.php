...
/**
 * Sync receiver for Spatie's `permissions` table. Mirrors RoleReceiver:
 * uuid-first locate with (name, guard_name) fallback for legacy rows.
 */
class PermissionReceiver extends DefaultReceiver
{
