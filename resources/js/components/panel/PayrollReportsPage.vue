         ...
         <div class="panel-card">
            ...
            <div class="panel-card-body p-0">
               ...
               <div v-if="!loading && detailPagination.last_page > 1" class="d-flex justify-content-center py-3 border-top">
                  <panel-pagination :links="detailPagination.links" :current-page="detailPagination.current_page" :last-page="detailPagination.last_page" aria-label="Payroll report pagination" @page-change="fetchReport" />
               </div>
            </div>
         </div>
   </div>
