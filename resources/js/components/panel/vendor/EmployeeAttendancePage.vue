            ...
            <table class="table table-striped table-hover align-middle mb-0">
                ...
                <tbody>
                    <tr v-for="r in records" :key="r.id" :class="{ 'table-success-soft': !r.checked_out_at }">
                        <td class="small">{{ formatDT(r.checked_in_at) }}</td>
                        <td>
                            <span v-if="r.checked_out_at" class="text-muted small">{{ formatDT(r.checked_out_at) }}</span>
                        ...
                        <td>
                            <span class="m-badge" :class="r.checked_out_at ? '' : 'm-badge--active'">
        ...
        <div class="d-md-none" v-if="!loading && records.length">
            <div class="member-card" v-for="r in records" :key="'ma' + r.id">
                <div class="member-card-top">
                    <div>
                        <div class="fw-semibold small">{{ formatDT(r.checked_in_at) }}</div>
                ...
                <div class="member-card-footer">
                    <span v-if="r.checked_out_at" class="text-muted small"><i class="bi bi-box-arrow-right me-1"></i>{{ formatDT(r.checked_out_at) }}</span>
...
export default {
    ...
    mounted() {
        ...
        this.logForm.checked_in_at = this.nowLocal();
        this.fetchRecords();
    },
