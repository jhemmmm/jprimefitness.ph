               ...
               <div class="modal-body">
                  ...
                  <div class="row g-3">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-text" v-else-if="suggestion && suggestion.taxable_earnings > 0">Calculated from ₱{{ $filters.formatMoney(suggestion.taxable_earnings) }} taxable earnings.</div>
