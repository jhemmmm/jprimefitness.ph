<template>
    <div class="branches-page">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <button v-if="$can('super-admin')" class="btn btn-danger px-3" @click="openAddModal">
        ...
        <div class="panel-card">
            ...
            <div v-else-if="branches.length === 0" class="text-center py-5 text-muted">
                ...
                <button class="btn btn-danger btn-sm mt-1" @click="openAddModal" v-else-if="$can('super-admin')">Add first branch</button>
            </div>
                    ...
                    <table class="table table-hover table-striped align-middle mb-0 panel-table">
                        <thead>
                            <tr>
                                ...
                                <th>Contact</th>
                                <th>Hours</th>
                                <th class="col-actions" v-if="$can('super-admin')"></th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <div>
                                                <span class="m-badge" :class="getStatusClass(b.status)">{{ statusLabel(b.status) }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <div class="d-md-none">
                    <div class="member-card" v-for="b in branches" :key="'mc' + b.id">
                        <div class="member-card-top">
                            ...
                            <div class="dropdown" v-if="$can('super-admin')">
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" v-model="form.name" :class="{ 'is-invalid': formErrors.name }" @input="autoSlug" placeholder="e.g. JPRIME Fitness Calabanga" />
                                <div class="invalid-feedback" v-if="formErrors.name">{{ formErrors.name }}</div>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label form-label-sm">Slug</label>
                                <input type="text" class="form-control" v-model="form.slug" :class="{ 'is-invalid': formErrors.slug }" placeholder="auto-generated from name" />
                                <div class="invalid-feedback" v-if="formErrors.slug">{{ formErrors.slug }}</div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div v-if="modalMode === 'edit'">
                            <div class="branch-photos-grid" v-if="form.photos && form.photos.length > 0">
                                <div class="branch-photo-item" v-for="(photo, i) in form.photos" :key="i">
                                    ...
                                    <button type="button" class="branch-photo-del" @click="deletePhoto(i)" :disabled="photoDeleting === i" title="Remove photo">
                        ...
                        <p class="text-muted small mb-0" v-else>Save the branch first to upload photos.</p>
                    </div>
...
export default {
    ...
    methods: {
        ...
        submitForm: function () {
            ...
            let url = this.modalMode === "edit" ? `/panel/branches/${this.form.id}` : "/panel/branches";
            let method = this.modalMode === "edit" ? "put" : "post";
        ...
        statusLabel: function (status) {
            var map = { open: "Open", closed: "Closed", coming_soon: "Coming Soon" };
