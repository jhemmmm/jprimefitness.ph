      ...
      <div class="panel-card p-4 mb-4">
         <div class="d-flex align-items-start gap-3 flex-wrap">
            ...
            <div class="flex-grow-1 min-w-0">
               ...
               <div class="text-muted small mb-2" v-if="localMember.branches && localMember.branches.length"><i class="bi bi-geo-alt me-1"></i>{{ localMember.branches.map((branch) => branch.name).join(", ") }}</div>
